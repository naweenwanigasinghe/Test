...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        custom:
          "123px 175px 60px 0 rgba(252, 252, 252, 0.00), 79px 112px 55px 0 rgba(252, 252, 252, 0.01), 44px 63px 46px 0 rgba(252, 252, 252, 0.05), 20px 28px 34px 0 rgba(252, 252, 252, 0.09), 5px 7px 19px 0 rgba(252, 252, 252, 0.10)",
