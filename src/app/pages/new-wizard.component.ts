...
export class NewWizardComponent {
  mode: Mode = 'template';
  currentStep = 1;
  ...
  constructor(private router: Router, private route: ActivatedRoute, private fb: FormBuilder) {
    ...
    this.route.data.subscribe(data => {
      this.mode = data['mode'] || 'template';
      if (this.mode === 'file') {
        this.stepLabels = ['File Info & Config.', 'User Assign', 'Related Documents', 'Confirmation'];
        this.totalSteps = 4;
        this.wizardTitle = 'New File';
        this.breadcrumbParent = 'File Management';
      } else {
        this.stepLabels = ['Template Info & Config.', 'Column Config.', 'User Assign', 'Related Documents', 'Confirmation'];
        this.totalSteps = 5;
        this.wizardTitle = 'New Template';
        this.breadcrumbParent = 'Template Management';
      }
    });
  }

  nextStep(){ if(this.currentStep < this.totalSteps){ this.currentStep++; } else { this.router.navigate([this.mode === 'file' ? '/file-management' : '/template-management']); } }
